# example set partitioning problem https://coin-or.github.io/pulp/CaseStudies/a_set_partitioning_problem.html
# same problem with warming the solver https://coin-or.github.io/pulp/guides/how_to_mip_start.html#example-problem
...
def happiness(
    ...
    """
    # return -abs(ord(table[0]) - ord(table[-1])) # to get max differences between elements in the same partition
...
# The optimal solution from a previous solving. x is the variable dictionary.
solution = {
    ("M", "N"): 1.0,
    ("E", "F", "G"): 1.0,
    ("A", "B", "C", "D"): 1.0,
